...
for(year in c(2016, 2017)) {
  ...
  soil <- Adiele_soil("Edo", year)
	...
	Pot_Edo <- LC_run(wth, pars=c(soil, crop, IRRIGF=TRUE), year=year, starttime = soil$DOYPL-100, endtime = soil$DOYHAR)
	mod[[paste0("Pot_Edo", yr)]] <- data.frame(Location="Edo", Year=year, Pot_Edo)
	  
	Wlim_Edo <- LC_run(wth, pars=c(soil, crop, IRRIGF=FALSE), year = year, starttime=soil$DOYPL-100, endtime= soil$DOYHAR)
	...
	Pot_CRS <- LC_run(wth, pars=c(soil, crop, IRRIGF=TRUE), year = year, starttime=soil$DOYPL-100, endtime=soil$DOYHAR)
	mod[[paste0("Pot_CRS", yr)]] <- data.frame(Location="CRS", Year=year, Pot_CRS)
	  
	Wlim_CRS <- LC_run(wth, pars=c(soil, crop, IRRIGF=FALSE), year = year, starttime=soil$DOYPL-100, endtime=soil$DOYHAR)
  ...
  soil <- Adiele_soil("Benue2", year)
	...
	Pot_Ben <- LC_run(wth, pars=c(soil, crop, IRRIGF=TRUE), year = year, starttime=soil$DOYPL-100, endtime=soil$DOYHAR)
	mod[[paste0("Pot_Ben", yr)]] <- data.frame(Location="Benue", Year=year, Pot_Ben)
	  
	Wlim_Ben <- LC_run(wth, pars=c(soil, crop, IRRIGF=FALSE), year=year, starttime=soil$DOYPL-100, endtime=soil$DOYHAR)
