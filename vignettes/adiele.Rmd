...
Figure4 <- function(){
  ...
  LeavesStemRootDynamics(mod$Pot_Edo17, mod$Wlim_Edo17,
                         BIOMASS=BIOM_Edo17, TITLE="Edo '17", LEG=TRUE)
  LeavesStemRootDynamics(mod$Pot_CRS16, mod$Wlim_CRS16,
                         BIOMASS=BIOM_CRS16,TITLE="CRS '16")
  LeavesStemRootDynamics(mod$Pot_CRS17, mod$Wlim_CRS17,
                         BIOMASS=BIOM_CRS17, TITLE="CRS '17")
  LeavesStemRootDynamics(mod$Pot_Ben16, mod$Wlim_Ben16,
                         BIOMASS=BIOM_BEN16, TITLE="BEN '16")
  LeavesStemRootDynamics(mod$Pot_Ben17, mod$Wlim_Ben17,
