...
for(year in c(2016, 2017)) {
  yr <- substr(year, 3, 4)
  p <- Adiele("Edo", year)
  Pot_Edo <- LC_run(p$weather, crop, p$soil, c(p$management, IRRIGF=TRUE), p$control)
	mod[[paste0("Pot_Edo", yr)]] <- data.frame(Location="Edo", Pot_Edo)
	  
  Wlim_Edo <- LC_run(p$weather, crop, p$soil, c(p$management, IRRIGF=FALSE), p$control)
	mod[[paste0("Wlim_Edo", yr)]] <- data.frame(Location="Edo", Wlim_Edo)
	
	# CRS, cross river ---------------------------------------------------------#
  p <- Adiele("Cross River", year)
  Pot_CRS <- LC_run(p$weather, crop, p$soil, c(p$management, IRRIGF=TRUE), p$control)
	mod[[paste0("Pot_CRS", yr)]] <- data.frame(Location="CRS", Pot_CRS)
	  
  Wlim_CRS <- LC_run(p$weather, crop, p$soil, c(p$management, IRRIGF=FALSE), p$control)
	mod[[paste0("Wlim_CRS", yr)]] <- data.frame(Location="CRS", Wlim_CRS)
	  
	#- Benue ----------------------------------------------------------------#
  p <- Adiele("Benue", year)
  Pot_Ben <- LC_run(p$weather, crop, p$soil, c(p$management, IRRIGF=TRUE), p$control)
	mod[[paste0("Pot_Ben", yr)]] <- data.frame(Location="Benue", Pot_Ben)
	  
  Wlim_Ben <- LC_run(p$weather, crop, p$soil, c(p$management, IRRIGF=FALSE), p$control)
