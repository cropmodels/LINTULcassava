...
The orginal R implementation was a translation by Rob van den Beuken from the FST version by Guillaume Ezui under supervision of Peter Leffelaar. Joy Adiele calibrated the model to Nigerian conditions. For this, the RUE parameter was set to the measured value and LAI was forced using measured data from trials in Edo, Nigeria, in 2016, to estimate the assimilate partitioning values for the cultivar used. Tom Schut checked, simplified and adapted the code. 
