...
LC_model_NPK <- function(Time, State, Pars, WDATA){
  ...
  # vapour pressure deficits
    ...
    if (TSUM < FINTSUM) {      
      ...
      AUX <- c(WSOTHA = WSO * 0.01, TRANRF = TRANRF, 
              ...
              NcLV = 100 * ANLVG / WLVG, NcST = 100 * ANST / WST, 
			  NcSO = 100 * ANSO / WSO, NcRT = 100 * ANRT / WRT,
              PcLV = 100 * APLVG/WLVG,   PcST = 100 * APST / WST, 
			  PcSO = 100 * APSO / WSO, PcRT = 100 * APRT / WRT,
              KcLV = 100 * AKLVG/WLVG,   KcST = 100 * AKST / WST, 
			  KcSO = 100 * AKSO / WSO, KcRT = 100 * AKRT / WRT,
