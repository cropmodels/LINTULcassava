#----------------------------------------------------------------------------------------------------#
# FUNCTION LINTUL2_CASSAVA_DEFAUL_PARAMETERS                                  
#
...
LINTUL2_CASSAVA_DEFAUL_PARAMETERS <-function() {
  ...
  return(c( 
    ...
    FST_CUTT     = 0.03,   # g stem g cuttings-1    :    Fraction of initial cutting allocated to stem
    ...
    SO2LV        = 0.8,      # g leaves DM g-1 storage  :    Conversion rate of storage organs dry matter to leaf dry matter
...
# Relative death rate of the leaves at different temperatures (d-1)
RDRT <- matrix(c(-10, 0.02, 
                 10,  0.02, 
                 15,  0.03, 
                 30,  0.06, 
                 50,  0.06),ncol=2,byrow=TRUE) 
